...
[![CI](https://github.com/UKPLab/arxiv2025-expert-eval-rw/actions/workflows/main.yml/badge.svg)](https://github.com/UKPLab/arxiv2025-expert-eval-rw/actions/workflows/main.yml)
...
To import classes/methods of `arxiv2025_expert_eval_rw` from inside the package itself you can use relative imports: 
...
```py
from arxiv2025_expert_eval_rw import BaseClass # Notice how I omit the file name
from arxiv2025_expert_eval_rw.subpackage import SubPackageClass # Here it's necessary because it's a subpackage
...
This is how you can use `arxiv2025_expert_eval_rw` from command line:

```bash
$ python -m arxiv2025_expert_eval_rw
```
